...
<html>
   <head>
      ...
      <title>Raiane Schunk Imoveis - Error 404</title>
   ...
   <body>
         ...
         <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
               <ul class="navbar-nav ms-auto">
                  <li class="nav-item"><a class="nav-link" href="/index.php" style="font-family: Roboto, sans-serif;font-weight: bold;color: rgb(255,255,255);">início</a></li>
      ...
      <main class="page landing-page" style="background: #f4f0f0;">
         ...
         <section class="projects-clean" style="padding: 58px;background: rgb(248,244,244);">
            <div class="row">
               <div class="col">
                  <h2 class="text-center" style="font-family: Ubuntu, sans-serif;padding-top: 0px;color: #a26c1e;"><br><strong>ERRO 404: JÁ CHEGOU O DISCO VOADOR</strong><br></h2>
               </div>
			</div>
			<div class="row justify-content-around">
			   <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8 col-xxl-8 item">
					<img class="img-fluid" style="width: 100%;" src="/assets/img/seubarriga.png" alt="Seu Barriga vindo cobrar o aluguel"</img>
			   </div>
            </div>
			<div class="row justify-content-around">
			   <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8 col-xxl-8 item">
					<a class="btn btn-primary text-uppercase shadow-none" role="button" style="background: rgb(0,0,0);font-family: Ubuntu, sans-serif;font-weight: bold;width: 100%;margin-bottom: 5px;border-style: none;" href="/index.php">&nbsp;VOLTAR&nbsp;</a>
			   </div>
            </div>
         </section>

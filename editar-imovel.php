         ...
         <section class="clean-block clean-form dark">
            <div class="container">
               <div class="block-heading">
                  <h2 style="font-family: Ubuntu, sans-serif;color: #a26c1e;font-weight: bold;">Editar um imóvel</h2>
                  <p style="color: rgb(0,0,0);font-family: Roboto, sans-serif;">Informe o código do imóvel a ser editado ou apagado, para recuperar as informações dele</p>
               </div>
               <form style="filter: hue-rotate(167deg);" action="editar-imoveis.php" method="GET">
                  <div class="mb-3"><label class="form-label" for="valor-imovel" style="color: rgb(0,0,0);font-family: Roboto, sans-serif;">Código do imóvel</label><input class="form-control" value="" type="text" id="codigo" name="codigo"></div>

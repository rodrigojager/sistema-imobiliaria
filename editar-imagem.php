         ...
         <section class="clean-block clean-form dark">
            <div class="container">
               <div class="block-heading">
                  ...
                  <p style="color: rgb(0,0,0);font-family: Roboto, sans-serif;">Informe o código do imóvel que possui as imagens a serem editadas ou apagadas</p>
               </div>
               <form style="filter: hue-rotate(167deg);" action="editar-imagens.php" method="GET">

...
<html>
   <head>
      ...
      <title>Raiane Schunk Imoveis - Login</title>
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
               <ul class="navbar-nav ms-auto">
				  ...
				  if (isset( $_COOKIE['logado'] ) and isset ($_COOKIE[ 'usuario' ])) {
					  ...
					  echo '<li class="nav-item"><a class="nav-link" href="/logout.php" style="font-family: Roboto, sans-serif;color: rgba(255,255,255,0.7);">(<u>'.$_COOKIE[ 'usuario' ].'</u>)&ensp;<b>sair</b>';
				  }
				  else {
					  echo '<li class="nav-item"><a class="nav-link" href="/login.php" style="font-family: Roboto, sans-serif;color: rgba(255,255,255,0.7);">Login';
				  }
				  ?>
				  </a></li>
               </ul>
         ...
         <section class="clean-block clean-form dark">
            <div class="container">
               <div class="block-heading">
                  <h2 style="font-family: Ubuntu, sans-serif;color: #a26c1e;font-weight: bold;">Login</h2>
				  <?php
					if (isset( $_COOKIE[ 'logado' ] )) {
						echo '<p style="color: rgb(0,0,0);font-family: Roboto, sans-serif;">Voce já está logado! Deseja fazer logout?</p>
						<p><a class="btn btn-primary text-uppercase shadow-none" role="button" style="width:80%;margin-top: 15px;font-weight: bold;font-family: Ubuntu, sans-serif;background: rgb(0,0,0);border-style: none;" href="/logout.php">Logout</a></p>
               </div>';
					}
					else {
					echo '
                  <p style="color: rgb(0,0,0);font-family: Roboto, sans-serif;">Faça o seu login</p>
               </div>
               <form style="filter: hue-rotate(167deg);" action="verificalogin.php" method="POST">
                  <div class="mb-3"><label class="form-label" for="usuario" style="color: rgb(0,0,0);font-family: Roboto, sans-serif;">Usuário</label><input class="form-control" value="" type="text" id="usuario" name="usuario"></div>
				  <div class="mb-3"><label class="form-label" for="vagas-garagem" style="color: rgb(0,0,0);font-family: Roboto, sans-serif;">Senha</label><input class="form-control" value="" type="password" id="senha" name="senha"></div>
